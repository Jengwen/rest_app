...
class FoodModel extends Model {
  ...
  Future<bool> fetchFoods() async {
    ...
    try {
      final http.Response response =
          await http.get("https://foodapp-d685f.firebaseio.com/foods.json");
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async{
    ...
    try{
      await http.put("https://foodapp-d685f.firebaseio.com/foods/${foodId}.json", body: json.encode(foodData));
